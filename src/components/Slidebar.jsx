...
const Slidebar = () => {
  ...
  return (
        ...
        mt-20'>
            <a className='text-black -rotate-90 tracking-widest w-[130px] cursor-pointer hover:scale-105 transition-all ease-in-out hover:text-red-500 ]' href="/Vijay_Resume.pdf" download="Vijay_Resume.pdf">Download CV</a>
